...
class DividerTest {
    ...
    void divideShouldThrowIllegalArgumentExceptionWhenDivisorIsZero() {
        final Exception exception = assertThrows(IllegalArgumentException.class, () -> divider.divide(10, 0));
        final String expected = "Divisor cannot be zero!";
    ...
    void divideShouldReturnCorrectDivisionResultIfDividentIsMoreThanDivisor() {
        ...
        final DivisionResult actual = divider.divide(divident, divisor);
